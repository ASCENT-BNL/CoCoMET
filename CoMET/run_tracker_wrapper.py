...
def _create_xarrs_and_cubes(
    ...
    Returns
    -------
    tracking_xarray : an xarray with the feature tracking information
        tracking_cube : an iris cube of the feature tracking variable
        segmentation_xarray : an xarray with the feature segmentation information
        segmentation_cube : an iris cube of the feature segmentation variables
    """
...
def _run_tracker_det_and_seg(dataset_name, tracker, tracking_info, CONFIG):
    """
    ...
    Returns:
        All variables required to create an ANTE-TRACE Analysis Object
    """
...
def _tobac_analysis(
    ...
    """
    Analyze tobac tracked variables
    ...
    UDAF_tracks, UDAF_segmentation_2d, UDAF_segmentation_3d = UDAF_values
...
def _moaap_analysis(dataset_name, user_return_dict, analysis_object, UDAF_values, CONFIG):
...
def _tams_analysis(dataset_name, user_return_dict, analysis_object, UDAF_values, CONFIG):
