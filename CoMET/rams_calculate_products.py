...
def rams_calculate_precip_rate(rams_xarray, pr_calc = '3d'):
    """
    Inputs:
    ...
    if pr_calc == '3d':
        ...
        total2D_precip_rate = np.sum(cloudMix + drizzleMix + rainMix + pris_iceMix + snowMix + aggregatesMix + graupelMix + hailMix, axis=1) * DN0
