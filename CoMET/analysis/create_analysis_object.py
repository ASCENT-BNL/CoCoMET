...
def create_analysis_object(
    ...
    if wrf_tracking_xarray is not None:
        ...
        if (
            wrf_tobac_features is not None
            or wrf_tobac_tracks is not None
            or wrf_tobac_segmentation_2d is not None
            or wrf_tobac_segmentation_3d is not None
        ):
            ...
            analysis_object_dict["wrf"]["tobac"] = {
                ...
                "UDAF_segmentation_2d": segmentation_to_UDAF(
                    wrf_tobac_segmentation_2d,
                    linking_to_UDAF(wrf_tobac_tracks, "tobac"),
                    "tobac",
                ),
                "UDAF_segmentation_3d": segmentation_to_UDAF(
                    wrf_tobac_segmentation_3d,
                    linking_to_UDAF(wrf_tobac_tracks, "tobac"),
                    "tobac",
                ),
            }
    ...
    if nexrad_tracking_xarray is not None:
        ...
        # Check if any tobac fields are not None
        if (
            nexrad_tobac_features is not None
            or nexrad_tobac_tracks is not None
            or nexrad_tobac_segmentation_2d is not None
            or nexrad_tobac_segmentation_3d is not None
        ):
            ...
            analysis_object_dict["nexrad"]["tobac"] = {
                ...
                "UDAF_segmentation_2d": segmentation_to_UDAF(
                    nexrad_tobac_segmentation_2d,
                    linking_to_UDAF(nexrad_tobac_tracks, "tobac"),
                    "tobac",
                ),
                "UDAF_segmentation_3d": segmentation_to_UDAF(
                    nexrad_tobac_segmentation_3d,
                    linking_to_UDAF(nexrad_tobac_tracks, "tobac"),
                    "tobac",
                ),
            }
    ...
    if goes_tracking_xarray is not None:
        ...
        # Check if any tobac fields are not None
        if (
            goes_tobac_features is not None
            or goes_tobac_tracks is not None
            or goes_tobac_segmentation_2d is not None
        ):
            ...
            analysis_object_dict["goes"]["tobac"] = {
                ...
                "UDAF_segmentation_2d": segmentation_to_UDAF(
                    goes_tobac_segmentation_2d,
                    linking_to_UDAF(goes_tobac_tracks, "tobac"),
                    "tobac",
                ),
